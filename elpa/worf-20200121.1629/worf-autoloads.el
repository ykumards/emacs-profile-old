...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "worf" '("worf-" "org-extract-archive-file" "hydra-" "company-begin-commands" "ac-trigger-commands")))
