...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(org-journal wttrin paredit)
...
you should place your code here."
  ...
  (setq org-agenda-files (list "~/Work/ORG/planner/coding.org.gpg"
                               "~/Work/ORG/planner/gtd.org.gpg"
                               "~/Work/ORG/planner/misc.org.gpg"))
  ...
  ;; Setup org capture and its shortcut
  (setq org-default-notes-file (concat org-directory "~/Work/ORG/notes/inbox.org.gpg"))
  (define-key global-map "\C-cc" 'org-capture)

  (setq org-capture-templates
        '(("t" "Todo" entry (file+headline "~/Work/ORG/planner/gtd.org.gpg" "Tasks")
           "* TODO %?\n  %i\n  %a")
          ("n" "Notes" entry (file+datetree "~/Work/ORG/notes/inbox.org.gpg")
           "* %?\nEntered on %U\n  %i\n  %a")
          ("l" "Logger" entry (file+datetree "~/Work/ORG/logger.org.gpg")
          "* %?\nEntered on %U\n %i\n %a"))
)
  ;;warn of deadline only 3 days ahead
  (setq org-deadline-warning-days 3)
  ;; Highlights matching parenthesis
  (setq initial-frame-alist '((top . 0) (left . 0) (width . 125) (height . 53)))
  (setq-default frame-title-format "%b (%f)")
  (setq calendar-location-name "New York, USA"
        calendar-latitude 40.73
        calendar-longitude -73.93)
  )
